...
import { homeServices, testimonials as testimonialsData } from "@/data/content";
...
const HomePage: FC = () => {
  ...
  const serviceIcons = [Banknote, Monitor, BarChart3, Users];
  const services = homeServices.map((service, index) => ({
    ...service,
    icon: serviceIcons[index] ?? Banknote,
  }));
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="text-sm text-gray-300">
                Cabinet de Conseil Financier & IT
              </span>
            </div>
      ...
      {/* ═══════════════════════════════════════════════════════════
          CAPESYS - Premium Product Showcase
        ═══════════════════════════════════════════════════════════ */}
      <section
        ref={petroleumRef}
        className="relative py-24 lg:py-32 bg-gradient-to-b from-[#0a1628] to-[#0f1f35] overflow-hidden"
      >
        {/* Accent line */}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-amber-500/10">
                <Image
                  ...
                  alt="Dashboard principal CAPEsys"
                  width={960}
                  height={540}
                  className="w-full aspect-video object-contain bg-[#0a1628]"
                  loading="lazy"
                />
                ...
                <div className="absolute bottom-4 right-4 bg-black/50 text-white px-3 py-1.5 rounded-full text-xs border border-white/20 backdrop-blur-sm">
                  Dashboard principal CAPEsys
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">CAPEsys</h2>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Solution complète de gestion pour stations-service. Contrôlez
                vos pompes, gérez vos stocks, et suivez vos finances en temps
                réel depuis une seule plateforme.
              </p>
      ...
      <section
        ref={ctaRef}
        className="py-24 lg:py-32 bg-gradient-to-br from-[#0a1628] to-[#0f1f35] relative overflow-hidden"
      >
        {/* Background elements */}
              ...
              <div className="grid lg:grid-cols-5 gap-8 items-center">
                ...
                <div className="lg:col-span-3">
                  ...
                  <div className="flex flex-wrap gap-6 text-gray-400 text-sm">
                    ...
                    <a
                      href="mailto:contact@capitalanalysis.ne"
                      className="flex items-center gap-2 hover:text-white transition-colors"
                    >
