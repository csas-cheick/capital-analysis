    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl p-8 text-center shadow-sm hover:shadow-lg transition-all duration-500 opacity-100 translate-y-0"
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="bg-gradient-to-br from-[#0a1628] to-[#0f1f35] rounded-3xl p-10 lg:p-16 text-center transition-all duration-700 delay-200 opacity-100 translate-y-0">
