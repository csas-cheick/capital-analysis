        ...
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {kpis.map((kpi, index) => (
              <div
                key={index}
                className="text-center p-6 bg-white/5 rounded-xl border border-white/10 transition-all duration-500 opacity-100 translate-y-0"
                style={{ transitionDelay: `${index * 100}ms` }}
              >
            ...
            <div className="relative">
              ...
              <div className="space-y-8">
                {roadmap.map((item, index) => (
                  <div
                    key={index}
                    className="relative flex gap-6 transition-all duration-500 opacity-100 translate-x-0"
