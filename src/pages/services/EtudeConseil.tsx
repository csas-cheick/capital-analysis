...
import { Search, FileText, Target, Lightbulb, CheckCircle, ArrowRight } from "lucide-react";
...
const EtudeConseil: FC = () => {
  ...
  const services = [
    {
      ...
      description: "Analyses approfondies pour comprendre votre environnement concurrentiel.",
      features: ["Analyse concurrentielle", "Études sectorielles", "Veille stratégique"],
    },
    {
      icon: FileText,
      title: "Business Plans",
      description: "Élaboration de plans d'affaires solides pour convaincre partenaires et investisseurs.",
      features: ["Plans financiers", "Stratégie commerciale", "Prévisions"],
    },
    {
      icon: Lightbulb,
      title: "Conseil Stratégique",
      description: "Accompagnement dans la définition et la mise en œuvre de votre stratégie.",
  ...
  const approach = [
    ...
    { title: "Recommandations", description: "Solutions concrètes et actionnables" },
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-24">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-purple-500/20 border border-purple-500/30 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm text-purple-300 font-medium">Service</span>
            </div>
            ...
            <p className="text-lg text-gray-400 leading-relaxed max-w-2xl">
              Des analyses approfondies et des recommandations stratégiques 
              pour guider vos décisions et maximiser votre impact.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Approach Section */}
      <section ref={approachRef} className="py-20 lg:py-28 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          
          <div className={`max-w-2xl mx-auto text-center mb-16 transition-all duration-700 ${approachVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Notre Approche
            </h2>
            <p className="text-gray-600">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {approach.map((item, index) => (
              <div
                key={index}
                className={`bg-white rounded-xl p-6 text-center shadow-sm transition-all duration-500 ${
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">
              Parlons de vos enjeux et définissons ensemble la meilleure stratégie.
            </p>
            <Link to="/contact">
