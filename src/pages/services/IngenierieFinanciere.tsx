...
import { TrendingUp, BarChart3, PieChart, LineChart, CheckCircle, ArrowRight } from "lucide-react";
  ...
  const services = [
    {
      ...
      description: "Création de modèles prévisionnels robustes pour anticiper vos besoins et optimiser vos décisions.",
      features: ["Prévisions de trésorerie", "Analyse de scénarios", "Projections 3-5 ans"],
    },
    {
      icon: PieChart,
      title: "Structuration Financière",
      description: "Optimisation de votre structure de capital et recherche de financements adaptés.",
      features: ["Levées de fonds", "Dossiers bancaires", "Négociation investisseurs"],
    },
    {
      icon: LineChart,
      title: "Analyse de Performance",
      description: "Analyse de vos indicateurs clés pour identifier les leviers d'amélioration.",
      features: ["Tableaux de bord", "Ratios financiers", "Recommandations"],
    },
  ];

  const process = [
    { step: "01", title: "Diagnostic", description: "Analyse de votre situation actuelle" },
    { step: "02", title: "Stratégie", description: "Élaboration d'un plan sur mesure" },
    { step: "03", title: "Mise en œuvre", description: "Déploiement des solutions" },
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-24">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-emerald-500/20 border border-emerald-500/30 px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm text-emerald-300 font-medium">Service</span>
            </div>
      ...
      <section ref={processRef} className="py-20 lg:py-28 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className={`max-w-2xl mx-auto text-center mb-16 transition-all duration-700 ${processVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Notre Approche
            </h2>
            <p className="text-gray-600">
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8">
              Discutons de vos objectifs et définissons ensemble la meilleure approche.
            </p>
            <Link to="/contact">
