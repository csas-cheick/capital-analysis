...
const GoalsPage: FC = () => {
  ...
  const goals = [
    {
      ...
      description: "Optimiser les processus de nos clients grâce à des audits précis et des solutions logicielles sur mesure.",
    },
    {
      icon: TrendingUp,
      title: "Impact Financier",
      description: "Identifier les leviers de valorisation et structurer les meilleures stratégies financières.",
    },
    {
      icon: Users,
      title: "Expansion Régionale",
      description: "Faciliter l'accès aux marchés numériques et physiques en Afrique de l'Ouest.",
    },
  ];
  ...
  const roadmap = [
    { year: "2023", title: "Création", description: "Lancement de Capital Analysis au Niger" },
    { year: "2024", title: "CapitalPetroleum", description: "Développement de notre solution phare" },
    { year: "2025", title: "Expansion", description: "Partenariats régionaux" },
    { year: "2026", title: "Innovation", description: "Nouvelles solutions digitales et IA" },
  ];
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Notre feuille de route pour accompagner la croissance 
              de nos clients et contribuer au développement économique régional.
            </p>
          </div>
        </div>
      </section>
      ...
      <section ref={goalsRef} className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className={`max-w-2xl mx-auto text-center mb-16 transition-all duration-700 ${goalsVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
      ...
      <section ref={kpiRef} className="py-20 lg:py-28 bg-[#0a1628]">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className={`max-w-2xl mx-auto text-center mb-16 transition-all duration-700 ${kpiVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            ...
            {kpis.map((kpi, index) => (
              <div
                ...
                className={`text-center p-6 bg-white/5 rounded-xl border border-white/10 transition-all duration-500 ${
                  kpiVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
                }`}
                style={{ transitionDelay: `${index * 100}ms` }}
              >
      ...
      <section ref={roadmapRef} className="py-20 lg:py-28 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className={`max-w-2xl mx-auto text-center mb-16 transition-all duration-700 ${roadmapVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Notre Parcours
            </h2>
            <p className="text-gray-600">
                ...
                {roadmap.map((item, index) => (
                  <div
                    ...
                    className={`relative flex gap-6 transition-all duration-500 ${
                      roadmapVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"
                    }`}
              ...
              <div className="grid lg:grid-cols-5 gap-8 items-center">
                ...
                <div className="lg:col-span-3">
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    de vos ambitions. Planifiez un échange sans engagement.
                  </p>
                </div>
                ...
                <div className="lg:col-span-2 flex flex-col gap-4">
                  ...
                  <a href="mailto:contact@capital-analysis.com" className="w-full">
