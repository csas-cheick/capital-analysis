    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-24">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Cabinet de conseil en ingénierie financière et solutions IT, 
              nous accompagnons les entreprises du Niger et d'Afrique de l'Ouest 
              dans leur transformation et leur croissance.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className={`transition-all duration-700 ${missionVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-10"}`}>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                ...
                financières et technologiques de haute qualité. Notre expertise couvre 
                l'ingénierie financière, le développement de logiciels sur mesure, 
                et le conseil stratégique.
              </p>
              
              <p className="text-gray-600 leading-relaxed mb-8">
                Notre approche combine rigueur analytique et innovation technologique 
                pour répondre aux défis uniques de chaque entreprise que nous accompagnons.
              </p>
              ...
              <div className="flex flex-wrap gap-6">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-600 mb-1">3 ans</div>
            ...
            {/* Right - Visual */}
            <div className={`transition-all duration-700 delay-200 ${missionVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-10"}`}>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-8 lg:p-12">
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm col-span-2">
                      ...
                      <p className="text-sm text-gray-500">Votre réussite est notre priorité</p>
                    </div>
                  </div>
                </div>
      ...
      <section ref={valuesRef} className="py-20 lg:py-28 bg-gray-50">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className={`max-w-2xl mx-auto text-center mb-16 transition-all duration-700 ${valuesVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
      ...
      <section ref={teamRef} className="py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className={`max-w-2xl mx-auto text-center mb-16 transition-all duration-700 ${teamVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Notre Équipe
            </h2>
            <p className="text-gray-600">
          ...
          <div className={`bg-gradient-to-br from-[#0a1628] to-[#0f1f35] rounded-3xl p-10 lg:p-16 text-center transition-all duration-700 delay-200 ${teamVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Notre équipe réunit des consultants financiers expérimentés, 
              des développeurs talentueux et des experts en gestion d'entreprise, 
              tous unis par la volonté d'accompagner nos clients vers le succès.
            </p>
