        ...
        <div className="flex items-center h-20">
          ...
          <div className="ml-auto hidden lg:flex items-center gap-3">
            ...
            <Link href="/contact" onClick={closeMenus}>
              <button
                type="button"
                className={`group flex items-center gap-2 px-5 py-2.5 rounded-lg font-medium text-sm transition-all ${
                  isScrolled
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100">
            <Link href="/contact" onClick={closeMenus}>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 bg-[#0a1628] text-white px-6 py-3 rounded-lg font-medium"
              >
                Nous contacter
